(function () {
  ...
  const MODELS = {
    ...
    battleship: {
      scale: 3.05,
      vertices: [
        [-18, 0, -52], [18, 0, -52], [31, 0, 50], [-31, 0, 50],
        [-15, 11, -26], [15, 11, -26], [22, 11, 34], [-22, 11, 34],
        [-7, 20, -8], [7, 20, -8], [8, 20, 16], [-8, 20, 16],
        [-12, 15, 24], [12, 15, 24],
        [-5, 27, 2], [5, 27, 2],
        [-20, 14, -6], [20, 14, -6], [-22, 17, 7], [22, 17, 7],
        [0, 22, -20], [0, 24, 34]
      ],
      faces: [
        { i: [0, 1, 2, 3], color: "#4f6070" },
        { i: [4, 5, 6, 7], color: "#8fa1b0" },
        { i: [0, 1, 5, 4], color: "#647687" },
        { i: [1, 2, 6, 5], color: "#59697a" },
        { i: [2, 3, 7, 6], color: "#435465" },
        { i: [8, 9, 10, 11], color: "#c8d1d8" },
        { i: [7, 6, 13, 12], color: "#738896" },
        { i: [8, 9, 15, 14], color: "#adbcca" },
        { i: [16, 8, 11, 18], color: "#5e6f7f" },
        { i: [9, 17, 19, 10], color: "#6a7b8a" },
        { i: [20, 9, 8], color: "#d8e0e6" },
        { i: [10, 19, 21, 11], color: "#5d6f81" }
      ]
    },
    carrier: {
      scale: 3.5,
      vertices: [
        [-24, 0, -66], [24, 0, -66], [38, 0, 62], [-38, 0, 62],
        [-22, 8, -48], [22, 8, -48], [32, 8, 56], [-32, 8, 56],
        [-28, 12, -2], [28, 12, -2], [30, 12, 48], [-30, 12, 48],
        [-12, 23, -30], [8, 23, -30], [8, 23, 2], [-12, 23, 2],
        [-10, 34, -18], [6, 34, -18], [6, 34, -2], [-10, 34, -2],
        [-20, 15, -55], [20, 15, -55], [0, 17, 28],
        [-24, 15, 18], [24, 15, 18]
      ],
      faces: [
        { i: [0, 1, 2, 3], color: "#525f6f" },
        { i: [4, 5, 6, 7], color: "#6f7f8f" },
        { i: [8, 9, 10, 11], color: "#808f9d" },
        { i: [0, 1, 5, 4], color: "#5b6a79" },
        { i: [1, 2, 6, 5], color: "#4f5e6d" },
        { i: [2, 3, 7, 6], color: "#455362" },
        { i: [12, 13, 14, 15], color: "#96a5b4" },
        { i: [16, 17, 13, 12], color: "#6d7c89" },
        { i: [17, 18, 14, 13], color: "#8192a2" },
        { i: [16, 12, 15, 19], color: "#5b6978" },
        { i: [20, 21, 5, 4], color: "#aebdca" },
        { i: [10, 24, 23, 11], color: "#6f808f" },
        { i: [20, 21, 22], color: "#dbe4ea" }
      ]
    },
    flagship: {
      scale: 3.35,
  ...
  function buildTerrain(stage) {
    ...
    if (terrain === "harbor") {
      ...
      meshes.push(createBoxMesh(560, 0, 1510, 320, 38, 220, ["#4a4d5e", "#7b7f90", "#686c7d", "#55596a", "#424656", "#5c6172"]));
      meshes.push(createBoxMesh(0, 0, 1460, 180, 24, 160, ["#4e5868", "#808a99", "#6b7483", "#5a6372", "#495260", "#5d6776"]));
      meshes.push(createBoxMesh(-640, 38, 1510, 44, 66, 44, ["#596274", "#8f98a8", "#6d7686", "#616b7a", "#57606f", "#646e7d"]));
      meshes.push(createBoxMesh(-525, 38, 1490, 52, 82, 52, ["#5f6778", "#9ca4b2", "#737b8b", "#687181", "#5b6473", "#687182"]));
      meshes.push(createBoxMesh(-438, 38, 1536, 40, 56, 40, ["#576071", "#9098a6", "#697282", "#5e6777", "#555e6d", "#616a79"]));
      meshes.push(createBoxMesh(642, 38, 1518, 46, 64, 46, ["#596274", "#8f98a8", "#6d7686", "#616b7a", "#57606f", "#646e7d"]));
      meshes.push(createBoxMesh(528, 38, 1492, 54, 88, 54, ["#5f6778", "#9ca4b2", "#737b8b", "#687181", "#5b6473", "#687182"]));
      meshes.push(createBoxMesh(436, 38, 1532, 40, 58, 40, ["#576071", "#9098a6", "#697282", "#5e6777", "#555e6d", "#616a79"]));
