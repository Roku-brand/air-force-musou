(function () {
  ...
  const MODELS = {
    player: {
      ...
      faces: [
        { i: [0, 1, 3], color: "#dff7ff" },
        { i: [0, 4, 1], color: "#b4d1ff" },
        { i: [3, 1, 2], color: "#82a7d7" },
        { i: [1, 4, 2], color: "#93bced" },
        { i: [1, 5, 2], color: "#45637f" },
        { i: [6, 0, 3], color: "#f0dc78" },
        { i: [0, 7, 4], color: "#f0dc78" },
        { i: [6, 7, 8], color: "#526b8d" }
      ]
    },
    fighter: {
      scale: 1.18,
      ...
      faces: [
        { i: [0, 1, 3], color: "#cadbf0" },
        { i: [0, 4, 1], color: "#aac6e0" },
        { i: [3, 1, 2], color: "#6b85a1" },
        { i: [1, 4, 2], color: "#7c99b6" },
        { i: [1, 5, 2], color: "#374d61" },
        { i: [7, 0, 3], color: "#f07d54" },
        { i: [0, 8, 4], color: "#f07d54" },
        { i: [7, 8, 6], color: "#51667b" }
      ]
    },
    sam: {
      scale: 1.8,
