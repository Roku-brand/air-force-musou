(function () {
  ...
  function buildStageCardVisual(stage) {
    ...
    return [
      ...
      '    <div class="sea-shadow"></div>',
      '    <div class="sea-reflection"></div>',
      '    <div class="hull-bottom"></div>',
      '    <div class="hull-side-left"></div>',
      '    <div class="hull-side-right"></div>',
      '    <div class="deck-main"></div>',
      '    <div class="deck-upper"></div>',
      '    <div class="bridge"></div>',
      '    <div class="turret turret-front"></div>',
      '    <div class="turret turret-mid"></div>',
      '    <div class="turret turret-aft"></div>',
      '    <div class="mast"></div>',
      '  </div>',
      '</div>'
    ].join("");
